...
function displayResult(bmi, gender, age) {
    ...
    interpretation.textContent = `Berat badan Anda ${bmiCategory.textContent}. Untuk usia Anda (${age} tahun), ${gender === 'male' ? 'pria' : 'wanita'} dengan berat badan seperti Anda memiliki resiko ${bmiCategory.textContent.toLowerCase()}.`;
